...
final class AcceptIdea extends \Prooph\Common\Messaging\Command
{
    use \Prooph\Common\Messaging\PayloadTrait;

    public const MESSAGE_NAME = 'AulaSoftwareLibre\Gata\Application\Idea\Command\AcceptIdea';
    ...
    public static function with(\AulaSoftwareLibre\Gata\Domain\Idea\Model\IdeaId $ideaId): AcceptIdea
    {
        return new self([
