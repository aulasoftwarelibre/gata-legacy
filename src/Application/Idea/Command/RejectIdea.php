...
final class RejectIdea extends \Prooph\Common\Messaging\Command
{
    use \Prooph\Common\Messaging\PayloadTrait;

    public const MESSAGE_NAME = 'AulaSoftwareLibre\Gata\Application\Idea\Command\RejectIdea';
    ...
    public static function with(\AulaSoftwareLibre\Gata\Domain\Idea\Model\IdeaId $ideaId): RejectIdea
    {
        return new self([
