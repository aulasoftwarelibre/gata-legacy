...
class IdeaCapacityLimitedSpec extends ObjectBehavior
{
    ...
    public function it_represents_idea_limited_event_occurrence(): void
    {
        ...
        $this->limit()->shouldBeLike(self::LIMIT);
    }
}
